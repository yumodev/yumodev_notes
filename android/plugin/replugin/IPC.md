...
public class IPC {
    ...
    private static String sCurrentProcess;//当前进程
    private static int sCurrentPid;//当前进程ID
    private static String sPackageName;//包名
    private static String sPersistentProcessName;//常驻小进程名字

    private static boolean sIsPersistentProcess;//是否常驻进程
    private static boolean sIsUIProcess;//是否UI进程
